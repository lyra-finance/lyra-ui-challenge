...
import Lyra, { Deployment, Market, Board, Strike } from '@lyrafinance/lyra-js';
...
const fromBigNumber = (bn: BigNumber): number =>
  parseFloat(utils.formatUnits(bn.toString(), 18));

// Converts a number to BigNumber (for SDK arguments)
const toBigNumber = (val: number): BigNumber =>
  utils.parseEther(val.toString());
